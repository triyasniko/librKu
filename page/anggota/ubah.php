				...
				<div class="card-block">
					<form method="POST">
						...
						<div class="form-group row">
							...
							<div class="col-sm-10">
								<input type="text" class="form-control" name="tempat_lahir" value="<?php echo $tampil['tempat_lahir']; ?>">
							</div>
						</div>
						<div class="form-group row">
							...
							<div class="col-sm-10">
								<div class="form-check-inline">
							    	<label class="form-check-label">
							        	<input type="radio" class="form-check-input" name="jk" value="l" <?php if ($jk1=='l') {echo "checked";} ?>>Laki-Laki
							    	</label>
							    </div>
							    <div class="form-check-inline">
							    	<label class="form-check-label">
							        	<input type="radio" class="form-check-input" name="jk" value="p" <?php if ($jk1=='p') {echo "checked";} ?>>Perempuan
							    	</label>
							    </div>
							</div>
						</div>
						<div class="form-group row">
							...
							<div class="col-sm-10">
								<select name="prodi" class="form-control">
									<option value="-" <?php if ($prodi=='-') {echo "selected";} ?>>--Silahkan Pilih--</option>
						...
						<div class="form-group row">
							<div class="col-sm-12 text-right">
								<input class="btn btn-primary" type="submit" name="ubah" value="Simpan">
...
<?php 
	if (isset($_POST["ubah"])) {
		...
		$sql=$koneksi->query("UPDATE tb_anggota SET
			nama='$nama',tempat_lahir='$tempat_lahir',tgl_lahir='$tgl_lahir',jk='$jk',prodi='$prodi' 
