            ...
            <div class="row">
                <div class="col-sm-12">
                    ...
                    <div class="login-card card-block auth-body">
                        <form class="md-float-material" role="form" method="POST">
                            ...
                            <div class="auth-box">
                                ...
                                <div class="row m-t-30">
                                    <div class="col-md-12">
                                        <input type="submit" class="btn btn-primary btn-md btn-block waves-effect text-center m-b-20" value="LOGIN" name="login">LOGIN
                                    </div>
                                </div>
                            </div>
                        </form>
                        ...
                        <?php 
                            if (isset($_POST['login'])) {
                                ...
                                if ($ketemu>=1) {
                                    $_SESSION['petugas']=$sql->fetch_assoc();
